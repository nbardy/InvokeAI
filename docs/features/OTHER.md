...
For better intuition into what these options do in practice, [here is a graphic demonstrating them both](https://github.com/invoke-ai/InvokeAI/blob/main/docs/assets/truncation_comparison.jpg?raw=true) in use. In generating this graphic, perlin noise at initialization was programmatically varied going across on the diagram by values 0.0, 0.1, 0.2, 0.4, 0.5, 0.6, 0.8, 0.9, 1.0; and the threshold was varied going down from
